...
class configNavSearch extends configNav {
  ...
  protected function navbar() {
    ...
    $this->args['content_wrap'] = '[{"tag":"button","attributes":{"class":"uk-button uk-button-text uk-navbar-toggle"},"content":[{"tag":"i","attributes":{"style":"min-width:20px;","uk-search-icon":"{\"i18n\": {\"submit\": \"__label__\"}}","aria-hidden":"true"},"close":true},{"tag":"span","attributes":{"class":"screen-reader-text"},"content":"__label__","close":true}],"close":true},{"tag":"div","attributes":{"class":"uk-dropdown uk-padding-small","uk-drop":"mode: click; boundary: !.uk-navbar; stretch: x; flip: false; target-y: !.uk-navbar"}},{"tag":"div","attributes":{"class":"uk-grid-small uk-flex-middle","uk-grid":""},"content_end":{"tag":"div","attributes":{"class":"uk-width-auto"},"content":{"tag":"button","attributes":{"uk-close":"","class":"uk-button uk-button-text uk-drop-close"},"content":{"tag":"span","attributes":{"class":"screen-reader-text"},"content":"__label_close__","close":true},"close":true},"close":true}},{"tag":"div","attributes":{"class":"uk-width-expand"}}]';
